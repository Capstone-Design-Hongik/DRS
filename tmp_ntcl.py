...
import pandas as pd
df = yf.Ticker('NTCL').history(start='2025-01-01', end='2026-03-29')
close = df['Close']
high = df['High']
print(f'NTCL 3월 27일 종가: ${close.iloc[-1]:.2f}')
...
print(f'1. Dist_High52: {dist_high52*100:.2f}%')
print(f'2. ROC_60: {roc_60*100:.2f}%')
print(f'3. Dist_SMA50: {dist_sma50*100:.2f}%')
print(f'4. Dist_SMA20: {dist_sma20*100:.2f}%')
print(f'5. RSI_14: {rsi:.2f}')
